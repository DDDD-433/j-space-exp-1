# Portions derived from anthropics/jacobian-lens (jlens/hooks.py)
# Copyright 2026 Anthropic PBC
# Copyright 2026 The OpenJSpace Authors
# SPDX-License-Identifier: Apache-2.0
"""Forward-hook context manager for capturing the residual stream.

Fitting needs *differentiable* tensors at exact residual-stream locations, so
we hook the residual blocks rather than relying on ``output_hidden_states``
(which does not let us root the autograd graph at the earliest source layer).
"""
